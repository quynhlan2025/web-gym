...
const testimonials = [
  {
    name: 'Nguyễn Thị Mai', role: 'Marketing Manager',
    ...
    initials: 'NM', rating: 5, months: '6 tháng',
  },
  {
    name: 'Trần Văn Hùng', role: 'Software Engineer',
    ...
    initials: 'TH', rating: 5, months: '4 tháng',
  },
  {
    name: 'Lê Phương Linh', role: 'Entrepreneur',
    ...
    initials: 'LL', rating: 5, months: '1 năm',
  },
  {
    name: 'Phạm Đức Minh', role: 'Doctor',
    ...
    initials: 'DM', rating: 5, months: '8 tháng',
  },
];
  ...
  return (
    <section id="testimonials" ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`mb-16 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <div className="flex gap-3">
              <button onClick={prev} className="w-12 h-12 border border-white/20 hover:border-[#E8192C] flex items-center justify-center text-white hover:text-[#E8192C] transition-colors active:scale-90">
                <ChevronLeft size={20} />
              </button>
              <button onClick={next} className="w-12 h-12 bg-[#E8192C] hover:bg-[#c4152a] flex items-center justify-center text-white transition-colors active:scale-90">
        ...
        {/* Carousel */}
        <div className={`grid lg:grid-cols-2 gap-6 transition-all duration-700 delay-200 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {/* Featured */}
          <div className="lg:col-span-1 bg-[#060e1c] border border-[#E8192C]/20 p-10 relative overflow-hidden">
